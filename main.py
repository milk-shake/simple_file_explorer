...
# Increase the Dots Per inch so it looks sharper
ctypes.windll.shcore.SetProcessDpiAwareness(True)

root = Tk()
# set a title for our file explorer - lets call it "milk_shake Explorer main window
root.title('The Milk_shake Explorer')
